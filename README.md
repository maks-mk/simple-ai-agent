...
**v6.3b (Deterministic, Safer Tools & Logging)**
...
### 💻 Продвинутый CLI
- **Real-time Streaming:** Посимвольный вывод без задержек.
- **Token Tracking:** Гибридный подсчет токенов (Native API или локальный `tiktoken` для несовместимых провайдеров).
- **Rich UI:** Визуализация процесса "мышления" и статусов инструментов.
...
| `test_updates.py` | Быстрые проверки форматирования/поиска после правок. |
