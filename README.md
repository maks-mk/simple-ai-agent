...
**v7.34b (Resilient CLI & System Tools)**
...
- **Local Unique Tools (Локальные инструменты):**
  ...
  - **Media Tools:** Интеграция с `yt-dlp` для работы с медиа-контентом (скачивание видео, извлечение аудио).
...
- **UX Improvements:** Улучшены сообщения при восстановлении сессии и исправлены визуальные баги CLI (задержка стриминга, застывший статус).
