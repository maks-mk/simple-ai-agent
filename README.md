...
**v7.0 Enhanced (Deterministic, Safer Tools & Logging)**
...
- **UI/UX Enhanced:**
    - **Header Info:** В шапке CLI теперь отображается активная модель (Gemini/GPT) и количество загруженных инструментов.
